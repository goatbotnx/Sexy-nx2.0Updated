...
module.exports = {
    ...
    onStart: async function ({ message }) {
        ...
        ctx.font = '14px Arial';
        ctx.fillText(`POWARED BY XALMAN | VERSION 4.0`, centerX, height - 20);

        const cachePath = path.join(__dirname, 'cache', `ping_pro_${Date.now()}.png`);
